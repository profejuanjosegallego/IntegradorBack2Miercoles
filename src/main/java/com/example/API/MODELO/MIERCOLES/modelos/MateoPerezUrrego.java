...
@Entity
@Table(name = "MateoPerezUrrego")
public class MateoPerezUrrego {
    ...
    public MateoPerezUrrego() {

    }

    public MateoPerezUrrego(Integer id, String direccion, Boolean esHinchaVerdolaga) {
        this.id = id;
